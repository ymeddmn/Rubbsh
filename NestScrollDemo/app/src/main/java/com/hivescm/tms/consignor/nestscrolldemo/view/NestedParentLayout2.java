...
/**
 * Created by mayong on 2018/5/17.
 */
 ...
 */
public class NestedParentLayout2 extends LinearLayout implements NestedScrollingParent {
    ...
    public NestedParentLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            }
//        }
        float height1 = child1.getHeight();
        float translationY = child1.getTranslationY();
        if(dy<0){
            child1.setTranslationY(0);
        }else {
            if(translationY<-height1){
                child1.setTranslationY(-height1);
            }else {
                child1.setTranslationY(translationY-dy);
                if(translationY>-height1&&translationY<0){
//                    child2.setTranslationY(child1.getTranslationY());
                    child2.offsetTopAndBottom(-dy);
                }
                consumed[1]=dy;
            }
        }
