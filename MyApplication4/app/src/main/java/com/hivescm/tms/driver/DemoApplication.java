package com.hivescm.tms.driver;
...
public class DemoApplication extends Application {
    ...
    private static final String APP_ID = "2882303761517712225";
    // user your appid the key.
    private static final String APP_KEY = "5361771224225";
    ...
    public void onCreate() {
        ...
        if (shouldInit()) {
            ...
            MiPushClient.setAlias(this, "523", null);
        }
