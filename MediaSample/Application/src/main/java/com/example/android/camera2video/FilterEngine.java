...
public class FilterEngine {
    ...
    public FilterEngine(int OESTextureId, Context context) {
        ...
        vertexShader = loadShader(GL_VERTEX_SHADER, com.example.android.camera2video.Utils.readShaderFromResource(mContext, R.raw.base_vertex_shader));
        fragmentShader = loadShader(GL_FRAGMENT_SHADER, com.example.android.camera2video.Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader));
